...
class TeReg extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final textColor = Colors.grey.shade800; // Always dark grey text for input
      ...
      body: Container(
        ...
        child: Form(
          ...
          child: ListView(
            ...
            children: [
              _buildTextField(_firstNameController, 'First Name', Icons.person, textColor),
              SizedBox(height: 16),
              _buildTextField(_lastNameController, 'Last Name', Icons.person, textColor),
              SizedBox(height: 16),
              _buildTextField(_emailController, 'Email', Icons.email, textColor, isEmail: true),
              SizedBox(height: 16),
              _buildPasswordField(_passwordController, 'Password', textColor),
              SizedBox(height: 16),
              _buildPasswordField(_confirmPasswordController, 'Confirm Password', textColor),
              SizedBox(height: 24),
              ElevatedButton(
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          hintText: label,
          hintStyle: TextStyle(color: Colors.grey.shade800),
          prefixIcon: Icon(Icons.lock, color: Colors.grey.shade800, size: 20),
          filled: false,
          border: InputBorder.none,
          contentPadding: EdgeInsets.symmetric(vertical: 16),
          // Make sure error text is visible
